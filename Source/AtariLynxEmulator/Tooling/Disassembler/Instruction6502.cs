...
namespace KillerApps.Emulation.Processors
{
	public class Instruction6502
	{
		...
		public static Instruction6502[] InstructionSet = new Instruction6502[256]
			{
				...
				new Instruction6502(0x0A, "ASL A", AddressingMode.Accumulator), 
				null,
				...
				new Instruction6502(0x1A, "INC A", AddressingMode.Accumulator), 
				null,
				...
				new Instruction6502(0x2A, "ROL A", AddressingMode.Accumulator), 
				null,														 
				...
				new Instruction6502(0x3A, "DEC A", AddressingMode.Accumulator), 
				null,														 
				...
				new Instruction6502(0x4A, "LSR A", AddressingMode.Accumulator), 
				null,														 
				...
				new Instruction6502(0x6A, "ROR A", AddressingMode.Accumulator),
				null,														 
		...
		public static Instruction6502 Data(byte opcode)
		{
			Instruction6502 instruction = new Instruction6502(opcode, ".db", AddressingMode.Illegal);
			return instruction;
		}
	}
}
